        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           ...
           @endif
            <div class="bg-white overflow-hidden shadow-xl rounded p-4">
                <h2 class="font-extrabold text-teal-900 hover:text-teal-600 ml-3 text-2xl">Añadir Orden de Pollo</h2>
                <form wire:submit.prevent ="addPollo" enctype="multipart/form-data" method="POST">
                    @csrf
