        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           ...
           @endif
            <div class="bg-white overflow-hidden shadow-xl rounded p-4">
                <h2 class="font-extrabold text-teal-900 hover:text-teal-600 ml-3 text-2xl">Editar Combo</h2>
                <form wire:submit.prevent ="editCombo" enctype="multipart/form-data" method="POST">
                    @csrf
                 <div class="form-group">
                   ...
                   <select name="categoria" id="categoria" class="form-control" wire:model = "categoria">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <img src="{{ asset('storage/combo/' . $project_image) }}" width="120" class="img-thumbnail" alt="img">
                        </div>
                        <div> 
                            @if($new_image)
                                Imagen Nueva:
