            ...
            <div class="bg-white overflow-hidden shadow-xl rounded p-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">
                        <a href="{{route('addBebida')}}" class="btn btn-success">Agregar Nuevo Bebida</a>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered w-full text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td  class=" text-black">{{$bebida->id}}</td>
                                <td  class=" text-black">{{$bebida->categoria}}</td>
                                <td  class=" text-black">{{$bebida->title}}</td>
                                <td><img src="{{ asset('storage/bebida/' . $bebida->project_image) }}" width="120" class="img-thumbnail" alt="img"></td>
                                <td  class=" text-black">{{$bebida->descripcion}}</td>
                                <td  class=" text-black">{{$bebida->precio}}</td>
                                        
                                <td class="">
                                  
                                    <a href="{{route('editBebida', ['id'=>$bebida->id])}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit</a>
                                    <button href="#" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mx-1" wire:click.prevent="deleteBebida('{{$bebida->id}}')">Delete</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
